...
let
  inputs = {
    ...
    "ansi" = pkgs.stdenvNoCC.mkDerivation {
      name = "ansi";
      version = "v6.1.0";
      src = pkgs.fetchgit {
    ...
    "lcg" = pkgs.stdenvNoCC.mkDerivation {
      name = "lcg";
      version = "v3.0.0";
      src = pkgs.fetchgit {
    ...
    "mmorph" = pkgs.stdenvNoCC.mkDerivation {
      name = "mmorph";
      version = "v6.0.0";
      src = pkgs.fetchgit {
    ...
    "pipes" = pkgs.stdenvNoCC.mkDerivation {
      name = "pipes";
      version = "v7.0.1";
      src = pkgs.fetchgit {
    ...
    "quickcheck" = pkgs.stdenvNoCC.mkDerivation {
      name = "quickcheck";
      version = "v7.1.0";
      src = pkgs.fetchgit {
    ...
    "random" = pkgs.stdenvNoCC.mkDerivation {
      name = "random";
      version = "v5.0.0";
      src = pkgs.fetchgit {
    ...
    "spec" = pkgs.stdenvNoCC.mkDerivation {
      name = "spec";
      version = "v5.0.1";
      src = pkgs.fetchgit {
    ...
    "spec-quickcheck" = pkgs.stdenvNoCC.mkDerivation {
