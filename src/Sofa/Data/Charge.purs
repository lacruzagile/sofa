...
import Sofa.Data.SmartSpec (Charge(..), ChargeSingleUnit(..), ChargeKind, ChargeUnit(..), ChargeUnitId(..), DimValue, PricePerDim(..), PricePerDimSeg(..), PricePerDimUnit(..), PricePerDimUnitOptSeg(..), PricePerDimUnitSeg(..), Product(..))
